      ...
      <div>
        <BrowserRouter>
          <div className="App">
            ...
            <Route path="/index.js" component={Login2} />
            <Route path="/login.js" component={Login2} />
            <Route path="/login" component={Login2} />
            <Route path="/home.js" component={Home} />
            <Route path="/alfa_parts.js" component={AlfaParts} />
            <Route path="/GTV6_parts.js" component={GTV6Parts} />
            <Route path="/milano_parts.js" component={MilanoParts} />
            <Route path="/mechanics.js" component={Mechanics} />
            <Route path="/engine.js" component={Engine} />
